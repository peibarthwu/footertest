    ...
    move(e) {
      ...
      dashes.forEach((dash) => {
        ...
        if (Math.abs(dist - this.rad) < this.rad) {
          ...
          // }
          // else {
          //   const rotNeg = 180 - (90 * weight);
          //   dash.style.transform ='rotate(' + rotNeg.toString() + 'deg)';
          // }
          dash.style.transform = "rotate(" + rotString + "deg)";
        } else {
        ...
        if (dash === activeDash) {
          console.log(
            Math.sqrt(Math.pow(x - dashx, 2) + Math.pow(y - dashy, 2))
          );
          dash.classList.add("dash-active");
        }
      });

      //       for (let i = 0; this.dashCount; i++) {
...
const __vue_inject_styles__ = function (inject) {
  if (!inject) return;
  inject("data-v-cb6e1d92_0", {
    source:
      "body {\n  margin: 0;\n  padding: 0;\n}\n#app {\n  margin-top: 60px;\n  padding: 20px;\n}\n.line {\n  width: 100%;\n  display: flex;\n  flex-flow: row;\n}\n.dash {\n  background: black;\n  height: 100%;\n  flex: 1;\n  position: relative;\n}\n.dash-active {\n  background: red;\n}\n.dash-test {\n  background: green;\n}\n\n/*# sourceMappingURL=pen.vue.map */",
    map: {
      version: 3,
      sources: ["/tmp/codepen/vuejs/src/pen.vue", "pen.vue"],
      names: [],
      mappings:
        "AAmGA;EACA,SAAA;EACA,UAAA;AClGA;ADqGA;EACA,gBAAA;EAEA,aAAA;ACnGA;ADsGA;EACA,WAAA;EACA,aAAA;EACA,cAAA;ACnGA;ADsGA;EACA,iBAAA;EACA,YAAA;EACA,OAAA;EACA,kBAAA;ACnGA;ADsGA;EACA,eAAA;ACnGA;ADsGA;EACA,iBAAA;ACnGA;;AAEA,kCAAkC",
      file: "pen.vue",
      sourcesContent: [
        '<template>\n  <div id="app">\n    <div class="lines" @mousemove="move">\n      <template v-for="index in lineCount + 1">\n        <div\n          :class="`line line-${index}`"\n          :style="`margin-top:${\n            index > 1 ? lineCount - (lineCount - index) - 1 : 0\n          }px;height:${lineCount + 1 - index}px`"\n          @mousemove="move"\n          ref="line"\n        >\n          <template v-for="index in dashCount + 1">\n            <div class="dash" ref="dash"></div>\n          </template>\n        </div>\n      </template>\n    </div>\n\n    <!--     <template v-for="index in lineCount + 1">\n      <template v-if="index > 0 && index < lineCount + 1">\n        <svg\n          :viewBox="`0 0 1368 ${index}`"\n          fill="none"\n          xmlns="http://www.w3.org/2000/svg"\n          :style="`margin-top:${lineCount + 1 - index}px`"\n        >\n          <line\n            x1="0"\n            :y1="index / 2"\n            x2="1368"\n            :y2="index / 2"\n            stroke="black"\n            :stroke-width="index"\n          />\n        </svg>\n      </template>\n    </template> -->\n  </div>\n</template>\n\n<script>\nexport default {\n  data() {\n    return {\n      dashCount: 40,\n      lineCount: 23,\n      radiance: 9,\n      mouse: {\n        x: undefined,\n        y: undefined\n      }\n    };\n  },\n  mounted() {\n    window.addEventListener("mousemove", (e) => {\n      this.mouse.x = event.x;\n      this.mouse.y = event.y;\n    });\n  },\n  methods: {\n    clamp(num, min, max) {\n      return num <= min ? min : num >= max ? max : num;\n    },\n    move(e) {\n      const dashes = this.$refs.dash;\n      const activeDash = e.target;\n      const lines = this.$refs.line;\n      const lineIndex = lines.indexOf(activeDash.parentElement);\n      const dashIndex =\n        lineIndex > -1\n          ? [...lines[lineIndex].children].indexOf(activeDash)\n          : null;\n\n      const spread = (this.radiance - 1) / 2;\n\n      const activeLines = lines.slice(lineIndex - spread, lineIndex + 1 + spread);\n\n      dashes.forEach((dash) => {\n        dash.className = "dash";\n\n        if (dash === activeDash) {\n          dash.classList.add("dash-active");\n        }\n      });\n      \n//       for (let i = 0; this.dashCount; i++) {\n        \n//       }\n      \n//       activeLines.forEach((line) => {\n        \n//       });\n    }\n  }\n};\n</script>\n\n<style lang="scss">\nbody {\n  margin: 0;\n  padding: 0;\n}\n\n#app {\n  margin-top: 60px;\n\n  padding: 20px;\n}\n\n.line {\n  width: 100%;\n  display: flex;\n  flex-flow: row;\n}\n\n.dash {\n  background: black;\n  height: 100%;\n  flex: 1;\n  position: relative;\n}\n\n.dash-active {\n  background: red;\n}\n\n.dash-test {\n  background: green;\n}\n</style>\n',
        "body {\n  margin: 0;\n  padding: 0;\n}\n\n#app {\n  margin-top: 60px;\n  padding: 20px;\n}\n\n.line {\n  width: 100%;\n  display: flex;\n  flex-flow: row;\n}\n\n.dash {\n  background: black;\n  height: 100%;\n  flex: 1;\n  position: relative;\n}\n\n.dash-active {\n  background: red;\n}\n\n.dash-test {\n  background: green;\n}\n\n/*# sourceMappingURL=pen.vue.map */",
      ],
    },
    media: undefined,
