    ...
    move(e) {
      ...
      dashes.forEach((dash) => {
        ...
        if(controls.enabled){
          ...
          dist = Math.sqrt(Math.pow(dashx-this.mouse.x,2) + Math.pow(dashy-this.mouse.y,2));
        }
